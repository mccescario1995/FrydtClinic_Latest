...
@section('title', 'Create Prenatal Record')
...
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-0"><i class="fas fa-baby me-2"></i>Create Prenatal Record</h1>
                <p class="text-muted mb-0">Add a new prenatal care record for {{ $patient->name }}</p>
            </div>
            <div>
...
<div class="row">
    <div class="col-md-12">
        <form method="POST" action="{{ route('admin-portal.patients.store-prenatal-record', $patient->id) }}">
            @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-3">
                            ...
                            <input type="number" class="form-control" id="gestational_age_weeks" name="gestational_age_weeks" min="0" max="42">
                        </div>
                        <div class="col-md-3">
                            <label for="gestational_age_days" class="form-label">Gestational Age (Days)</label>
                            <input type="number" class="form-control" id="gestational_age_days" name="gestational_age_days" min="0" max="6">
                        </div>
                        <div class="col-md-3">
                            <label for="gravida" class="form-label">Gravida (G)</label>
                            <input type="number" class="form-control" id="gravida" name="gravida" min="0">
                        </div>
                        <div class="col-md-3">
                            <label for="para" class="form-label">Para (P)</label>
                            <input type="number" class="form-control" id="para" name="para" min="0">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control" id="abortion" name="abortion" min="0">
                        </div>
                        <div class="col-md-4">
                            <label for="living_children" class="form-label">Living Children</label>
                            <input type="number" class="form-control" id="living_children" name="living_children" min="0">
                        </div>
                        <div class="col-md-4">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-3">
                            ...
                            <input type="number" class="form-control" id="blood_pressure_systolic" name="blood_pressure_systolic" min="0">
                        </div>
                        <div class="col-md-3">
                            <label for="blood_pressure_diastolic" class="form-label">Blood Pressure Diastolic</label>
                            <input type="number" class="form-control" id="blood_pressure_diastolic" name="blood_pressure_diastolic" min="0">
                        </div>
                        <div class="col-md-3">
                            <label for="weight_kg" class="form-label">Weight (kg)</label>
                            <input type="number" step="0.1" class="form-control" id="weight_kg" name="weight_kg" min="0">
                        </div>
                        <div class="col-md-3">
                            <label for="height_cm" class="form-label">Height (cm)</label>
                            <input type="number" step="0.1" class="form-control" id="height_cm" name="height_cm" min="0">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-3">
                            ...
                            <input type="number" step="0.1" class="form-control" id="bmi" name="bmi" min="0">
                        </div>
                        <div class="col-md-3">
                            <label for="pulse_rate" class="form-label">Pulse Rate (bpm)</label>
                            <input type="number" class="form-control" id="pulse_rate" name="pulse_rate" min="0">
                        </div>
                        <div class="col-md-3">
                            <label for="respiratory_rate" class="form-label">Respiratory Rate</label>
                            <input type="number" class="form-control" id="respiratory_rate" name="respiratory_rate" min="0">
                        </div>
                        <div class="col-md-3">
                            <label for="temperature_celsius" class="form-label">Temperature (°C)</label>
                            <input type="number" step="0.1" class="form-control" id="temperature_celsius" name="temperature_celsius" min="0">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="fetal_heart_rate" name="fetal_heart_rate" min="0">
                        </div>
                        <div class="col-md-3">
                            <label for="fetal_position" class="form-label">Fetal Position</label>
                            <input type="text" class="form-control" id="fetal_position" name="fetal_position" maxlength="100">
                        </div>
                        <div class="col-md-3">
                            <label for="fetal_presentation" class="form-label">Fetal Presentation</label>
                            <input type="text" class="form-control" id="fetal_presentation" name="fetal_presentation" maxlength="100">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="hemoglobin_level" name="hemoglobin_level" maxlength="50">
                        </div>
                        <div class="col-md-4">
                            <label for="hematocrit_level" class="form-label">Hematocrit Level</label>
                            <input type="text" class="form-control" id="hematocrit_level" name="hematocrit_level" maxlength="50">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <textarea class="form-control" id="urinalysis" name="urinalysis" rows="2" maxlength="500"></textarea>
                        </div>
                        <div class="col-md-3">
                            <label for="vdrl_test" class="form-label">VDRL Test</label>
                            <input type="text" class="form-control" id="vdrl_test" name="vdrl_test" maxlength="50">
                        </div>
                        <div class="col-md-3">
                            <label for="hbsag_test" class="form-label">HBsAg Test</label>
                            <input type="text" class="form-control" id="hbsag_test" name="hbsag_test" maxlength="50">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <textarea class="form-control" id="risk_factors" name="risk_factors" rows="3"></textarea>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <textarea class="form-control" id="general_notes" name="general_notes" rows="3"></textarea>
                        </div>
                        <div class="col-md-6">
                            <label for="physician_notes" class="form-label">Physician Notes</label>
                            <textarea class="form-control" id="physician_notes" name="physician_notes" rows="3"></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="admin-card mb-4">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="iron_supplements" name="iron_supplements" value="1">
                        ...
                        <div class="col-md-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="calcium_supplements" name="calcium_supplements" value="1">
                        ...
                        <div class="col-md-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="vitamin_supplements" name="vitamin_supplements" value="1">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="td_vaccine_given" name="td_vaccine_given" value="1">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" class="form-control" id="td_vaccine_date" name="td_vaccine_date">
                        </div>
                        <div class="col-md-4">
                            <label for="td_vaccine_dose" class="form-label">TD Vaccine Dose</label>
                            <input type="number" class="form-control" id="td_vaccine_dose" name="td_vaccine_dose" min="0">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea class="form-control" id="counseling_topics" name="counseling_topics" rows="2"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <textarea class="form-control" id="patient_education" name="patient_education" rows="2"></textarea>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="next_visit_notes" name="next_visit_notes" rows="2"></textarea>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-1"></i>Create Prenatal Record
                            </button>
