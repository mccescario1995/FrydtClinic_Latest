...
<div class="page-header">
    ...
    <p class="page-subtitle">Update service information and settings</p>
</div>

<div class="admin-card">
    <div class="card-header">
        <h5 class="mb-0"><i class="fas fa-edit me-2"></i>Service Information</h5>
    </div>
    <div class="card-body">
        <form method="POST" action="{{ route('admin-portal.services.update', $service->id) }}">
            @csrf
            @method('PUT')
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                            ...
                            <option value="single" {{ old('type', $service->type) === 'single' ? 'selected' : '' }}>Single Service</option>
                            <option value="package" {{ old('type', $service->type) === 'package' ? 'selected' : '' }}>Package Service</option>
                        </select>
                        @error('type')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('service_type') is-invalid @enderror" id="service_type" name="service_type" required>
                            ...
                            <option value="laboratory" {{ old('service_type', $service->service_type) === 'laboratory' ? 'selected' : '' }}>Laboratory</option>
                            <option value="imaging" {{ old('service_type', $service->service_type) === 'imaging' ? 'selected' : '' }}>Imaging</option>
                            <option value="therapy" {{ old('service_type', $service->service_type) === 'therapy' ? 'selected' : '' }}>Therapy</option>
                            <option value="vaccination" {{ old('service_type', $service->service_type) === 'vaccination' ? 'selected' : '' }}>Vaccination</option>
                            <option value="prenatal_care" {{ old('service_type', $service->service_type) === 'prenatal_care' ? 'selected' : '' }}>Prenatal Care</option>
                            <option value="delivery" {{ old('service_type', $service->service_type) === 'delivery' ? 'selected' : '' }}>Delivery</option>
                            <option value="postnatal_care" {{ old('service_type', $service->service_type) === 'postnatal_care' ? 'selected' : '' }}>Postnatal Care</option>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('category') is-invalid @enderror" id="category" name="category" required>
                            ...
                            <option value="general_practice" {{ old('category', $service->category) === 'general_practice' ? 'selected' : '' }}>General Practice</option>
                            <option value="obstetrics_gynecology" {{ old('category', $service->category) === 'obstetrics_gynecology' ? 'selected' : '' }}>Obstetrics & Gynecology</option>
                            <option value="pediatrics" {{ old('category', $service->category) === 'pediatrics' ? 'selected' : '' }}>Pediatrics</option>
                            <option value="internal_medicine" {{ old('category', $service->category) === 'internal_medicine' ? 'selected' : '' }}>Internal Medicine</option>
                            <option value="surgery" {{ old('category', $service->category) === 'surgery' ? 'selected' : '' }}>Surgery</option>
                            <option value="emergency_care" {{ old('category', $service->category) === 'emergency_care' ? 'selected' : '' }}>Emergency Care</option>
                            <option value="preventive_care" {{ old('category', $service->category) === 'preventive_care' ? 'selected' : '' }}>Preventive Care</option>
                            <option value="diagnostic" {{ old('category', $service->category) === 'diagnostic' ? 'selected' : '' }}>Diagnostic</option>
                            <option value="therapeutic" {{ old('category', $service->category) === 'therapeutic' ? 'selected' : '' }}>Therapeutic</option>
                        </select>
                        @error('category')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('base_price') is-invalid @enderror"
                               id="base_price" name="base_price" value="{{ old('base_price', $service->base_price) }}" step="0.01" min="0" required>
                        @error('base_price')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('philhealth_price') is-invalid @enderror"
                               id="philhealth_price" name="philhealth_price" value="{{ old('philhealth_price', $service->philhealth_price) }}" step="0.01" min="0">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('discount_percentage') is-invalid @enderror"
                               id="discount_percentage" name="discount_percentage" value="{{ old('discount_percentage', $service->discount_percentage) }}" step="0.01" min="0" max="100">
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="philhealth_covered" name="philhealth_covered" value="1"
                                   {{ old('philhealth_covered', $service->philhealth_covered) ? 'checked' : '' }}>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('duration_minutes') is-invalid @enderror"
                               id="duration_minutes" name="duration_minutes" value="{{ old('duration_minutes', $service->duration_minutes) }}" min="1">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('advance_booking_days') is-invalid @enderror"
                               id="advance_booking_days" name="advance_booking_days" value="{{ old('advance_booking_days', $service->advance_booking_days) }}" min="0">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="time" class="form-control @error('start_time') is-invalid @enderror"
                                       id="start_time" name="start_time" value="{{ old('start_time', $service->start_time ? $service->start_time->format('H:i') : '') }}">
                                @error('start_time')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="time" class="form-control @error('end_time') is-invalid @enderror"
                                       id="end_time" name="end_time" value="{{ old('end_time', $service->end_time ? $service->end_time->format('H:i') : '') }}">
                                @error('end_time')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="available_emergency" name="available_emergency" value="1"
                                   {{ old('available_emergency', $service->available_emergency) ? 'checked' : '' }}>
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="requires_lab_results" name="requires_lab_results" value="1"
                                   {{ old('requires_lab_results', $service->requires_lab_results) ? 'checked' : '' }}>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('preparation_instructions') is-invalid @enderror"
                                  id="preparation_instructions" name="preparation_instructions" rows="3">{{ old('preparation_instructions', $service->preparation_instructions) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('post_service_instructions') is-invalid @enderror"
                                  id="post_service_instructions" name="post_service_instructions" rows="3">{{ old('post_service_instructions', $service->post_service_instructions) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('contraindications') is-invalid @enderror"
                                  id="contraindications" name="contraindications" rows="3">{{ old('contraindications', $service->contraindications) }}</textarea>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('required_equipment') is-invalid @enderror"
                                  id="required_equipment" name="required_equipment" rows="2">{{ old('required_equipment', $service->required_equipment) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('required_supplies') is-invalid @enderror"
                                  id="required_supplies" name="required_supplies" rows="2">{{ old('required_supplies', $service->required_supplies) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('staff_requirements') is-invalid @enderror"
                                  id="staff_requirements" name="staff_requirements" rows="2">{{ old('staff_requirements', $service->staff_requirements) }}</textarea>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('quality_indicators') is-invalid @enderror"
                                  id="quality_indicators" name="quality_indicators" rows="2">{{ old('quality_indicators', $service->quality_indicators) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('regulatory_requirements') is-invalid @enderror"
                                  id="regulatory_requirements" name="regulatory_requirements" rows="2">{{ old('regulatory_requirements', $service->regulatory_requirements) }}</textarea>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('consent_form_required') is-invalid @enderror"
                                  id="consent_form_required" name="consent_form_required" rows="2">{{ old('consent_form_required', $service->consent_form_required) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('documentation_requirements') is-invalid @enderror"
                                  id="documentation_requirements" name="documentation_requirements" rows="2">{{ old('documentation_requirements', $service->documentation_requirements) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('internal_notes') is-invalid @enderror"
                                  id="internal_notes" name="internal_notes" rows="2">{{ old('internal_notes', $service->internal_notes) }}</textarea>
            ...
            <div class="d-flex justify-content-between">
                <a href="{{ route('admin-portal.services.show', $service->id) }}" class="btn btn-outline-secondary">
